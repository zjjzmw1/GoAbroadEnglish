...
/// 初始化tabbar的几个页面
- (void)initTabbarVC {
    NSMutableArray *controllerArray = @[@"ViewController",@"StudyVC",@"ImageVC",@"NewMineVC"].mutableCopy;
    NSArray * titleArray = @[NSLocalizedString(@"首页", nil),NSLocalizedString(@"学习", nil),@"图片",NSLocalizedString(@"我的", nil)];
    NSArray *imageArray= @[@"tabbar_1",@"tabbar_3",@"tabbar_3",@"tabbar_4"];
    //选中图片数组
    NSArray *selImageArray = @[@"tabbar_1_s",@"tabbar_3_s",@"tabbar_3_s",@"tabbar_4_s"];
